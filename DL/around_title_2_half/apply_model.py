...
def get_args():
    ...
    parser.add_argument("--test_set", type=str, default=path+"around_title_2_before_test.csv")
...
def train(opt):
    ...
    checkpoint = torch.load(opt.saved_path + os.sep + "around_title_2_before.pkl")
