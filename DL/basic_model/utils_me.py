...
def get_evaluation(y_true, y_prob, list_metrics):
    ...
    if 'report' in list_metrics:
        ...
        p_scores = precision_score(true_labels,predicted_labels,average='macro')
        r_scores = recall_score(true_labels,predicted_labels,average='macro')
        f1_scores = f1_score(true_labels,predicted_labels,average='macro')
        # print(p_scores)
        # print(r_scores)
        # print(f1_scores)
    return output
