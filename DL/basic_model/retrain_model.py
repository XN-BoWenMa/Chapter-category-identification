...
def get_args():
    ...
    parser.add_argument("--train_set", type=str, default="acl_data_valid.csv")
    parser.add_argument("--test_set", type=str, default="acl_data_test.csv")
    parser.add_argument("--test_interval", type=int, default=1, help="Number of epoches between testing phases")
    parser.add_argument("--word2vec_path", type=str, default="glove.6B.100d.txt")
    # parser.add_argument("--log_path", type=str, default="tensorboard/han_voc")
    parser.add_argument("--saved_path", type=str, default="models_save")
...
def train(opt):
    ...
    checkpoint = torch.load(opt.saved_path + os.sep + "trained_model_double_attention.pkl") 
    ...
    optimizer = torch.optim.Adam(filter(lambda p: p.requires_grad, model.parameters()), lr=opt.lr, betas=(0.9, 0.99), weight_decay=0.0001)
    ...
    for epoch in range(opt.num_epoches):
        ...
        if epoch % opt.test_interval == 0:
            ...
            if te_loss + opt.es_min_delta < best_loss:
                ...
                torch.save(state, opt.saved_path + os.sep + "trained_model_double_attention.pkl")
            else:
                scheduler.step()
            if (epoch+1)==3:
