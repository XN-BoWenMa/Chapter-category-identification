...
class data_prefetcher():
    ...
    def preload(self):
        try:
            self.next_input, self.next_target, self.next_before1, self.next_before2, self.next_after1, self.next_after2, self.title, self.before_title1, self.after_title1, self.after_title2 = next(self.loader)
    ...
    def next(self):
        ...
        self.preload()
        return input, target, before1, before2, after1, after2, title_current, title_before1, title_before2, title_after1, title_after2
...
def get_args():
    ...
    parser.add_argument("--train_set", type=str, default=path+"around_2_content_with_title_train.csv")
    parser.add_argument("--test_set", type=str, default=path+"around_2_content_with_title_valid.csv")
    ...
    parser.add_argument("--filter_sizes_fuse", type=list, default=[1,2,3,4])
...
def train(opt):
    ...
    for epoch in range(opt.num_epoches):
        ...
        feature, label, before1, before2, after1, after2, title_current, title_before1, title_before2, title_after1, title_after2 = prefetcher.next()
        iter = 0
        ...
        # for iter, (feature, label) in enumerate(training_generator):
            ...
            predictions = model(feature, before1, before2, after1, after2, title_current, title_before1, title_before2, title_after1, title_after2)
        ...
        if epoch % opt.test_interval == 0:
            ...
            te_label_ls = []
            te_pred_ls = []
            for te_feature, te_label, te_before1, te_before2, te_after1, te_after2, te_title_current, te_title_before1, te_title_before2, te_title_after1, te_title_after2 in test_generator:
                ...
                with torch.no_grad():
                    ...
                    te_predictions = model(te_feature, te_before1, te_before2, te_after1, te_after2, te_title_current, te_title_before1, te_title_before2, te_title_after1, te_title_after2)
            ...
            if te_loss + opt.es_min_delta < best_loss:
                ...
                torch.save(state, opt.saved_path + os.sep + "around_2_content_with_title_cnn.pkl")
            else:
