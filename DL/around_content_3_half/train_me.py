...
class data_prefetcher():
    ...
    def preload(self):
        try:
            self.next_input, self.next_target, self.next_before1, self.next_before2, self.next_before3 = next(self.loader)
    ...
    def next(self):
        ...
        self.preload()
        return input, target, before1, before2, before3
...
def get_args():
    ...
    parser.add_argument("--train_set", type=str, default=path+"around_content_3_before_train.csv")
    parser.add_argument("--test_set", type=str, default=path+"around_content_3_before_valid.csv")
...
def train(opt):
    ...
    for epoch in range(opt.num_epoches):
        ...
        feature, label, before1, before2, before3 = prefetcher.next()
        iter = 0
        ...
        # for iter, (feature, label) in enumerate(training_generator):
            ...
            predictions = model(feature, before1, before2, before3)
        ...
        if epoch % opt.test_interval == 0:
            ...
            te_label_ls = []
            te_pred_ls = []
            for te_feature, te_label, te_before1, te_before2, te_before3 in test_generator:
                ...
                with torch.no_grad():
                    ...
                    te_predictions = model(te_feature, te_before1, te_before2, te_before3)
            ...
            if te_loss + opt.es_min_delta < best_loss:
                ...
                torch.save(state, opt.saved_path + os.sep + "around_content_3_before.pkl")
            else:
