...
class HierAttNet(nn.Module):
    ...
    def forward(self, input, before1, before2, before3, after1, after2, after3, title, title_before1, title_before2, title_before3, title_after1, title_after2, title_after3):
        ...
        before_feature3 = self.cnn_net(title_before3)
        input_before3 = torch.cat((output_before, before_feature3.float()), dim=1)
        final_list.append(input_before3.unsqueeze(1))
        ...
        before_feature2 = self.cnn_net(title_before2)
        input_before2 = torch.cat((output_before, before_feature2.float()), dim=1)
        final_list.append(input_before2.unsqueeze(1))
        ...
        before_feature1 = self.cnn_net(title_before1)
        input_before1 = torch.cat((output_before, before_feature1.float()), dim=1)
        final_list.append(input_before1.unsqueeze(1))
        #---------------------------------------------------------
        ...
        final_list.append(input_current.unsqueeze(1))
        ...
        after_feature1 = self.cnn_net(title_after1)
        input_after1 = torch.cat((output_after, after_feature1.float()), dim=1)
        final_list.append(input_after1.unsqueeze(1))
        ...
        after_feature2 = self.cnn_net(title_after2)
        input_after2 = torch.cat((output_after, after_feature2.float()), dim=1)
        final_list.append(input_after2.unsqueeze(1))
        ...
        after_feature3 = self.cnn_net(title_after3)
        input_after3 = torch.cat((output_after, after_feature3.float()), dim=1)
        final_list.append(input_after3.unsqueeze(1))
