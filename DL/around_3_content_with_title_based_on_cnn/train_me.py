...
class data_prefetcher():
    ...
    def preload(self):
        try:
            self.next_input, self.next_target, self.next_before1, self.next_before2, self.next_before3, self.next_after1, self.next_after2, self.next_after3, self.title, self.before_title1, self.before_title2, self.before_title3, self.after_title1, self.after_title2, self.after_title3 = next(self.loader)
        except StopIteration:
            self.next_input = None
            self.next_target = None
            self.next_before1 = None
            self.next_before2 = None
            self.next_before3 = None
            self.next_after1 = None
            self.next_after2 = None
            self.next_after3 = None
            self.title = None
            self.before_title1 = None
            self.before_title2 = None
            self.before_title3 = None
            self.after_title1 = None
            self.after_title2 = None
            self.after_title3 = None
            return
        with torch.cuda.stream(self.stream):
            ...
            self.next_before3 = self.next_before3.cuda(non_blocking=True)
            self.next_after1 = self.next_after1.cuda(non_blocking=True)
            self.next_after2 = self.next_after2.cuda(non_blocking=True)
            self.next_after3 = self.next_after3.cuda(non_blocking=True)
            self.title = self.title.cuda(non_blocking=True)
            self.before_title1 = self.before_title1.cuda(non_blocking=True)
            self.before_title2 = self.before_title2.cuda(non_blocking=True)
            self.before_title3 = self.before_title3.cuda(non_blocking=True)
            self.after_title1 = self.after_title1.cuda(non_blocking=True)
            self.after_title2 = self.after_title2.cuda(non_blocking=True)
            self.after_title3 = self.after_title3.cuda(non_blocking=True)
    ...
    def next(self):
        ...
        before3 = self.next_before3
        after1 = self.next_after1
        after2 = self.next_after2
        after3 = self.next_after3
        title_current = self.title
        title_before1 = self.before_title1
        title_before2 = self.before_title2
        title_before3 = self.before_title3
        title_after1 = self.after_title1
        title_after2 = self.after_title2
        title_after3 = self.after_title3
        self.preload()
        return input, target, before1, before2, before3, after1, after2, after3, title_current, title_before1, title_before2, title_before3, title_after1, title_after2, title_after3 
...
def get_args():
    ...
    parser.add_argument("--train_set", type=str, default=path+"around_3_content_with_title_train.csv")
    parser.add_argument("--test_set", type=str, default=path+"around_3_content_with_title_train.csv")
...
def train(opt):
    ...
    for epoch in range(opt.num_epoches):
        ...
        feature, label, before1, before2, before3, after1, after2, after3, title_current, title_before1, title_before2, title_before3, title_after1, title_after2, title_after3 = prefetcher.next()
        iter = 0
        ...
        # for iter, (feature, label) in enumerate(training_generator):
            if torch.cuda.is_available():
                ...
                before3 = before3.cuda()
                after1 = after1.cuda()
                after2 = after2.cuda()
                after3 = after3.cuda()
                title_current = title_current.cuda()
                title_before1 = title_before1.cuda()
                title_before2 = title_before2.cuda()
                title_before3 = title_before3.cuda()
                title_after1 = title_after1.cuda()
                title_after2 = title_after2.cuda()
                title_after3 = title_after3.cuda()
            optimizer.zero_grad()
            model._init_hidden_state() #初始化隐藏层
            predictions = model(feature, before1, before2, before3, after1, after2, after3, title_current, title_before1, title_before2, title_before3, title_after1, title_after2, title_after3)
        ...
        if epoch % opt.test_interval == 0:
            ...
            te_label_ls = []
            te_pred_ls = []
            for te_feature, te_label, te_before1, te_before2, te_before3, te_after1, te_after2, te_after3, te_title_current, te_title_before1, te_title_before2, te_title_before3, te_title_after1, te_title_after2, te_title_after3 in test_generator:
                ...
                if torch.cuda.is_available():
                    ...
                    te_title_current = te_title_current.cuda()
                    te_title_before1 = te_title_before1.cuda()
                    te_title_before2 = te_title_before2.cuda()
                    te_title_before3 = te_title_before3.cuda()
                    te_title_after1 = te_title_after1.cuda()
                    te_title_after2 = te_title_after2.cuda()
                    te_title_after3 = te_title_after3.cuda()
                with torch.no_grad():
                    model._init_hidden_state(num_sample)
                    te_predictions = model(te_feature, te_before1, te_before2, te_before3, te_after1, te_after2, te_after3, te_title_current, te_title_before1, te_title_before2, te_title_before3, te_title_after1, te_title_after2, te_title_after3)
            ...
            if te_loss + opt.es_min_delta < best_loss:
                ...
                torch.save(state, opt.saved_path + os.sep + "around_3_content_with_title_cnn.pkl")
            else:
