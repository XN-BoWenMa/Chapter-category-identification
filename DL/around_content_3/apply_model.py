...
def get_args():
    ...
    parser.add_argument("--test_set", type=str, default=path+"around_content_3_test.csv")
...
def train(opt):
    ...
    checkpoint = torch.load(opt.saved_path + os.sep + "around_content_3.pkl")
    ...
    # print(te_label)
    # print(type(te_label))
    # print(np.size(te_label))
    # print(te_pred.numpy())
    # print(type(te_pred.numpy()))
    # print(np.size(te_pred.numpy()))
