...
class MyDataset(Dataset):
    ...
    def __init__(self, data_path, dict_path, max_length_sentences=30, max_length_word=35):
        ...
        texts, labels, around_before1, around_before2, around_before3, around_after1, around_after2, around_after3 = [], [], [], [], [], [], [], []
    ...
    def __getitem__(self, index): #获取每一条数据 #并进行编码
        ...
        return document_encode.astype(np.int64), label, before_encode1.astype(np.int64), before_encode2.astype(np.int64), before_encode3.astype(np.int64), after_encode1.astype(np.int64), after_encode2.astype(np.int64), after_encode3.astype(np.int64) 
