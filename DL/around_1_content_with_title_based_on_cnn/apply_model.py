...
def get_args():
    ...
    parser.add_argument("--test_set", type=str, default=path+"around_1_content_with_title_test.csv")
...
def train(opt):
    ...
    checkpoint = torch.load(opt.saved_path + os.sep + "around_1_content_with_title_cnn.pkl")
