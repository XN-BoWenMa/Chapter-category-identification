...
class data_prefetcher():
    ...
    def preload(self):
        try:
            self.next_target, self.next_title, self.next_before1, self.next_before2, self.next_before3, self.next_after1, self.next_after2, self.next_after3 = next(self.loader)
    ...
    def next(self):
        ...
        self.preload()
        return target, title, before1, before2, before3, after1, after2, after3 
...
def get_args():
    ...
    parser.add_argument("--test_set", type=str, default=path+"around_title_3_valid.csv")
...
def train(opt):
    ...
    for epoch in range(opt.num_epoches):
        ...
        label, title, before1, before2, before3, after1, after2, after3 = prefetcher.next()
        iter = 0
        ...
        # for iter, (feature, label, title, before, after) in enumerate(training_generator,1):
            ...
            predictions = model(title, before1, before2, before3, after1, after2, after3)
        ...
        if epoch % opt.test_interval == 0:
            ...
            for te_label, te_title, te_before1, te_before2, te_before3, te_after1, te_after2, te_after3 in test_generator:
                ...
                with torch.no_grad():
                    ...
                    te_predictions = model(te_title, te_before1, te_before2, te_before3, te_after1, te_after2, te_after3)
            ...
            if te_loss + opt.es_min_delta < best_loss:
                ...
                torch.save(state, opt.saved_path + os.sep + "around_title_3.pkl")
            else:
