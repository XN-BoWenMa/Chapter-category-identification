...
class data_prefetcher():
    ...
    def preload(self):
        try:
            self.next_input, self.next_target, self.next_before = next(self.loader)
...
def get_args():
    ...
    parser.add_argument("--test_set", type=str, default=path+"around_content_1_before_valid.csv.csv")
...
def train(opt):
    ...
    for epoch in range(opt.num_epoches):
        ...
        feature, label, before = prefetcher.next()
        iter = 0
        ...
        # for iter, (feature, label) in enumerate(training_generator):
            ...
            predictions = model(feature, before)
        ...
        if epoch % opt.test_interval == 0:
            ...
            te_label_ls = []
            te_pred_ls = []
            for te_feature, te_label, te_before in test_generator:
                ...
                with torch.no_grad():
                    ...
                    te_predictions = model(te_feature, te_before)
            ...
            if te_loss + opt.es_min_delta < best_loss:
                ...
                torch.save(state, opt.saved_path + os.sep + "around_content_1_before")
            else:
