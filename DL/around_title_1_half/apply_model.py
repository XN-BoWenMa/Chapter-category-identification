...
def get_args():
    ...
    parser.add_argument("--test_set", type=str, default=path+"around_title_1_before_test.csv")
    ...
    parser.add_argument("--saved_path", type=str, default="model_save_2020_8")
...
def train(opt):
    ...
    checkpoint = torch.load(opt.saved_path + os.sep + "around_title_1_before.pkl")
