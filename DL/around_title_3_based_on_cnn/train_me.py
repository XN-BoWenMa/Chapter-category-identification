...
def train(opt):
    ...
    for epoch in range(opt.num_epoches):
        ...
        # for iter, (feature, label, title, before, after) in enumerate(training_generator,1):
            ...
            predictions = model(title, before1, before2, before3, after1, after2, after3, iter, epoch+1)
            ...
            if (iter) % 10 == 0:
                ...
                print("Train:Epoch: {}/{},  LIteration: {}/{},r: {}, Loss: {}, Accuracy: {}".format(
                    epoch + 1,
                    opt.num_epoches,
                    iter,
                    num_iter_per_epoch,
        ...
        if epoch % opt.test_interval == 0:
            ...
            if te_loss + opt.es_min_delta < best_loss:
                ...
                torch.save(state, opt.saved_path + os.sep + "around_title_3_new.pkl")
            else:
